...
import Janmastmi from '../../image/janmastmi2.svg';
import Vijay_Diwas from '../../image/IMG_20240726_195817.jpg';
import Summer_Camp from '../../image/SummerCamp.jpg';
import  Hindi  from '../../image/HindiDiwas.svg';
...
const PhotoGallery = () => {
  ...
  const photoData = [
    ...
    { id: 6, image: Janmastmi, title: "Janmashtami" },
    { id: 7, image: Hindi, title: "Hindi Diwas" },
    { id: 8, image: Summer_Camp, title: "Summer Camp" },
    { id: 9, image: Vijay_Diwas, title: "Vijay Diwas" },
