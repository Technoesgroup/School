...
import "../../Styles/Admission-CSS/AdmissionC2.css";
import { useState } from "react";
import MenuIcon from '@mui/icons-material/Menu';
import CloseIcon from '@mui/icons-material/Close';

function AdmissionC2() {
  const [activeIndex, setActiveIndex] = useState(0);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  const links = [
    { label: "Overview", target: "Overview-section" },
    { label: "Admission Process", target: "Admission-section" },
    { label: "Course&Fee", target: "Course&Fee-section" },
  ...
  return (
    <div className="AdmissionC2-Ab-NAV">
      ...
      <div className="desktop-menu">
        <ul>
          {links.map((link, index) => (
            ...
            >
              <span className="AdmissionC2-text-change">{link.label}</span>
            </li>
          ))}
        </ul>
      </div>
